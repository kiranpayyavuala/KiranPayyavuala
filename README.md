...
<a href="https://github.com/features/actions" target="_blank" rel="noreferrer"><img src="https://skillicons.dev/icons?i=githubactions" alt="GitHub Actions" title="GitHub Actions" width="36" height="36" /></a>
...
🔹**Sr. DevOps Engineer focused on cloud infrastructure, automation, CI/CD, reliability, and continuous improvement.** <br>
...
Migrating monolithic applications to **microservices** and transitioning from **single-tenant to multi-tenant architecture**.

🌱 **Learning:** Kubernetes • Terraform • Platform Engineering

☁️ **Cloud:** AWS • Nutanix

⚙️ **DevOps:** Jenkins • GitHub Actions • Docker • Kubernetes • EKS • Ansible • CI/CD

📊 **Monitoring:** Datadog • Site24x7 • AWS CloudWatch

🐧 **OS:** Linux (CentOS, Ubuntu) • Windows Server (2016, 2022, 2025)
...
🔍 **Learn the manual process deeply** — follow it step by step, understand every action, and know why each step is required.

🧩 **Break complexity into smaller chunks** — divide complex problems into manageable pieces and implement them incrementally.

 ✅ **Validate before automating** — make sure the process is correct, reliable, and repeatable before turning it into automation.

⚙️ **Automate with understanding** — eliminate repetitive work and transform complex processes into simple, reliable automation.
